...
/*
 * Class of miscellaneous support functions used throughout the program.
 */
public class Support {
    ...
    public static int bitsToInt(String bits) {
        ...
        //  I used to use 'Integer.parseInt(bits, 2);' but it doesn't work when you try to specify the most significant bit.
        ...
        for (int i = 0; i < maxBitStringSize && i < bits.length(); i++) {
            ...
            //  If it's not on, we don't need to do anything else, it defaults to off
        }
    ...
    /*
     * Converts an integer object to an int. If it's null, it has a zero value.
     */
