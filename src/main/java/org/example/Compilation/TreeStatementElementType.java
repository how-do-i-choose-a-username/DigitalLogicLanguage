...
/*
    ...
    Unkown is for when an element has a token, but what exactly that token is currently unkown
...
*/
enum TreeStatementElementType { Unkown, Variable, Constant, Function, SoloBuiltin, DualBuiltin, Intermediate, NullType };